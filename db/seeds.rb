quotes = [
    ...
    {quote: "Sorcery is the sauce fools spoon over failure to hide the flavor of their own incompetence.", character: "Tyrion Lannister"},
    ...
    {quote: "'It's all fallen on me..', 'As has Jaime repeatedly, according to Stannis Baratheon.'", character: "Cersei Lannister and Tyrion Lannister"},
    {quote: "Grand Maester Pycelle made that same joke. You must be proud to be as funny as a man whose balls brush his knees.", character: "Tyrion Lannister"},
    ...
    {quote: "Why are all the gods such vicious cunts? Where's the god of tits and wine?", character: "Tyrion Lannister"},
]
